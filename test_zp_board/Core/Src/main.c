...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
  //uint32_t min_reload = __HAL_TIM_GET_AUTORELOAD(&htim4) * 0.05;
  /* USER CODE END 1 */
  ...
  MX_USART3_UART_Init();
  /* USER CODE BEGIN 2 */
  //testGPIO();             //GPIO Testing
  //testTimers();           //Timer Testing
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    //testSPI(&hspi2);      //SPI Testing
    testUART(&huart4);    //UART Testing
    HAL_Delay(1000);
    /* USER CODE END WHILE */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : SPI2_NSS_Pin IO6_Pin IO7_Pin IO8_Pin
                           IO9_Pin IO10_Pin */
  GPIO_InitStruct.Pin = SPI2_NSS_Pin|IO6_Pin|IO7_Pin|IO8_Pin
                          |IO9_Pin|IO10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
