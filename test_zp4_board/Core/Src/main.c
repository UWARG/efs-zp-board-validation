...
int main(void)
{
  ...
  while (1)
  {
	  //testI2CTx(&hi2c1);    //I2C Testing (Transmit)
	  //testI2CRx(&hi2c1);    //I2C Testing (Receive)

	  // Example: testing SPI1 with two different slaves
	  //testSPI(&hspi1, SPI1_NSS1_GPIO_Port, SPI1_NSS1_Pin);
	  //testSPI(&hspi1, SPI1_NSS2_GPIO_Port, SPI1_NSS2_Pin);
	  //testSPI(&hspi2, SPI2_NSS_GPIO_Port, SPI2_NSS_Pin);
	  //testSPI(&hspi4, SPI4_NSS_GPIO_Port, SPI4_NSS_Pin);
	  //testUART(&huart4);
	  HAL_Delay(1000);
    /* USER CODE END WHILE */
